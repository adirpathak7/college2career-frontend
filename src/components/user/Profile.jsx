        ...
        <>
            ...
            <div className="w-full min-h-screen bg-white text-gray-900 py-10 px-4 md:px-10">
                ...
                {isLoading ? (
                    ...
                    <div className="max-w-4xl mx-auto bg-blue-50 rounded-2xl shadow-lg px-6 py-10">
                        {data.reasonOfStatus && (
                            <div className="mb-6 px-4 py-3 bg-red-100 text-red-600 border border-red-400 rounded-lg text-sm font-medium animate-pulse">
                                🚫 {data.reasonOfStatus}
                            </div>
                        )}
                        ...
                        <div className="sm:items-center">
                            <div className="relative w-full h-48 sm:h-48 rounded-t-2xl overflow-hidden mb-6">
                                ...
                                />
                                <div className="absolute bottom-0 left-0 bg-blue-800/50 w-full px-6 py-3">
                            ...
                            <div className="flex-1 text-center sm:text-left">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="mt-4 sm:mt-0 inline-flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium"
                                    >
                        ...
                        <div className="mt-8 border-t border-gray-300 pt-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900 mb-2">📞 Contact Info</h2>
                                <p className="text-blue-700 text-sm">Phone: {data.contactNumber}</p>
                                <p className="text-blue-700 text-sm">Status: {data.status}</p>
                            </div>

                            <div>
                                <h2 className="text-lg font-semibold text-gray-900 mb-2">🏢 Company Details</h2>
                                <p className="text-blue-700 text-sm">Employee Size: {data.employeeSize}</p>
                                <p className="text-blue-700 text-sm">Industry: {data.industry}</p>
                            </div>
                        </div>
                    </div>
                ) : (
